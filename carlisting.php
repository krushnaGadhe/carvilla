  ...
  <div style="display: flex">
    <div style="width: 20%">
      ...
      <div style="display: flex">
        ...
        <input  disabled type="text" class="form-control m-2" value="1500000" id="maxPriceRange" />
      </div>
      <input id="priceRange" type="range" class="w-100 m-2"  min="100000" max="1500000" onchange="rangeChange()"/>
      <div>
...
function applyFilter(maxprice)
{
  $.ajax({
        ...
        type: "POST",
        data: {
          "RESULT_TYPE":"APPLY_FILTER","MAXPRICE":maxprice
        },
        success: function(res) {
          console.log(res)
          var jobj= JSON.parse(res)
